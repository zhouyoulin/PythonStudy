  ...
  stu = Student("xiaowang",16)
    ...
    - 类方法
      ...
      if __name__ == '__main__':
        ...
        ```
- 继承
    - 面向对象主要的好处之一就是代码的重用，实现重用的方式之一就是继承机制
    - 语法
    ```python
  class Parent:
    pass
  ...
  class Child(Parent): # 继承Parent类
    ...
    ```
    - 继承的特点
        - 子类如果有构造方法，在继承中基类的构造方法不会被自动调用，需要在子类的构造方法专门调用
        - 在子类中调用父类的方法的时候，可以使用super().func()来调用，也可以使用父类名来调用该方法，但是必须加上参数 self
        - 继承中方法的重写，python首先查找子类中对应的方法，如果没有才会去找父类的方法
- 多继承
    - 在python中一个子类可以拥有多个父类，子类拥有所有父类方法和属性
    - python中如果几个父类都存在相同的方法，在python2x中采用经典类的mro查找方法，python3x中采用新式类的方式
    - 经典类中查找方法采用的是深度优先  
    ![avater](https://img2018.cnblogs.com/blog/988316/201901/988316-20190115224835226-706493974.png)
    - python3新式类的查找方法
